    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ width: "100%", maxWidth: 380 }}>
          <h1 style={{ fontSize: 26, fontWeight: 800, color: "#1e293b", marginBottom: 6 }}>Бүртгүүлэх</h1>
          <p style={{ fontSize: 14, color: "#64748b", marginBottom: 28 }}>
            Бүртгэлтэй юу?{" "}
            <a href="/login" style={{ color: "#2563eb", textDecoration: "none", fontWeight: 600 }}>Нэвтрэх</a>
          </p>
